...
*/
-- AlterTable
ALTER TABLE "comment_notification_data" RENAME COLUMN "task_name" TO "tsak_title";

-- AlterTable
ALTER TABLE "task_assignation_notifications" RENAME COLUMN "task_name" TO "task_title";
