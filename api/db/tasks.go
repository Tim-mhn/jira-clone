...
func NewTaskManager(um *UserRepository, pm *ProjectRepository) *TaskManager {
	tm := TaskManager{}
	tm.um = um
	tm.pm = pm
...
func (tm *TaskManager) CreateTask(points int, title string, assigneeID string, projectID string) (models.Task, error) {
